class PackingLists::EditComponent < ApplicationComponent
  ...
  def view_template
    render ApplicationLayout.new(title: "Edit #{@packing_list.name}", current_user: @current_user) do
      div class: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8" do
        ...
        div class: "mb-8" do
          ...
          p class: "mt-2 text-sm text-gray-600" do
            "Update the name of your packing list."
          end
        end
        ...
        div class: "bg-white rounded-lg shadow-sm border border-gray-200 p-6" do
          form_with model: [ @road_trip, @packing_list ], local: true, class: "space-y-6" do |form|
            ...
            div class: "flex items-center justify-between pt-4" do
              ...
              form.submit "Update Packing List",
