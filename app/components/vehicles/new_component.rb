class Vehicles::NewComponent < ApplicationComponent
  ...
  def view_template
    render ApplicationLayout.new(title: "Add Vehicle", current_user: @current_user) do
      div class: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8" do
        ...
        div class: "mb-8" do
          ...
          p class: "mt-2 text-sm text-gray-600" do
            "Add a vehicle to your garage to track fuel economy and use in road trips."
          end
        end
    ...
    div class: "space-y-6" do
      ...
      div do
        ...
        form.text_field :name,
                        ...
                        placeholder: "e.g., Blue Betty, My Honda, Weekend Rider...",
                        required: true
        render_field_error(:name)
        p class: "mt-1 text-xs text-gray-500" do
          "Give your vehicle a name you'll recognize"
        end
      end
      ...
      div do
        ...
        form.text_field :make_model,
                        class: "w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm",
                        placeholder: "e.g., Honda Civic, BMW R1200GS, Trek Mountain Bike..."
      ...
      div do
        ...
        p class: "mt-1 text-xs text-gray-500" do
          "Optional: Upload a photo of your vehicle"
        end
      end
    end
  end
