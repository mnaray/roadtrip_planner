            ...
            div class: "relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6" do
              ...
              div class: "flex items-center justify-between mb-4" do
                ...
                link_to @road_trip,
                  ...
                  svg_raw svg_path(stroke_linecap: "round", stroke_linejoin: "round", stroke_width: "2", d: "M6 18L18 6M6 6l12 12"),
              ...
              unless @is_edit_mode
                div class: "mt-4 p-3 bg-blue-50 rounded-md" do
                  div class: "flex" do
                    svg_raw svg_path(fill_rule: "evenodd", d: "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z", clip_rule: "evenodd"),
                            class: "h-5 w-5 text-blue-400 mt-0.5 mr-2", fill: "currentColor", viewBox: "0 0 20 20"
